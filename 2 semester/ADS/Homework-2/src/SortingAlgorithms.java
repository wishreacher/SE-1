public class SortingAlgorithms {
    ...
    /*  Короткий опис цього алгоритму:
        Ми починаємо з найпершого елементу масиву, визначаємо його як найменший елемент.
        Далі ми рухаємось через весь масив у пошуках нового мінімуму.
        Коли знаходимо нове мінімальне число - міняємо його місцями з тим елементом
        від якого починали пошук та повторюємо це поки не закінчиться масив.
    */
